...
--
-- Host: localhost:8889
-- Generation Time: Sep 17, 2024 at 06:12 PM
...
(104, 'Introduciton to Psychology', 'Psychology'),
...
(1, 101, 'Spring', 2023, 'Dr. Smith'),
(2, 102, 'Spring', 2024, 'Prof. Johnson'),
(3, 103, 'Fall', 2023, 'Dr. Lee'),
(4, 104, 'Spring', 2023, 'Prof. Brown'),
...
--
ALTER TABLE `course`
  MODIFY `Course_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
...
--
ALTER TABLE `Register`
  ADD CONSTRAINT `register_ibfk_1` FOREIGN KEY (`Student_ID`) REFERENCES `Student` (`Student_ID`) ON DELETE CASCADE,
